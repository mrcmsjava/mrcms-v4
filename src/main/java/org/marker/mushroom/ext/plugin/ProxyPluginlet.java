...
public class ProxyPluginlet {
    ...
    public ProxyPluginlet(Pluginlet pluginlet) throws Exception {
        ...
        templateFilePath = PathUtils.normalizePath(SystemConfig.getInstance().getPluginsPath() + File.separator );//+ this.object._config.get("module") + File.separator);
        ...
        cfg = freeMarkerConfigurer.createConfiguration();
...
//            if(null == template){
//                String content = FileSystemUtils..get(new File(templateFilePath + path));
//
